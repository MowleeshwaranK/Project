...
{
    /* Source Image info */
    char *src_image_fname;     //name of image
    FILE *fptr_src_image;      //address of file
    uint image_capacity;   //size of source file
   // uint bits_per_pixel;
    char *image_data;

    /* Secret File Info */
    char *secret_fname;      // sorce data file name
    FILE *fptr_secret;        //adress of source file
    char extn_secret_file[MAX_FILE_SUFFIX];  //secret file extn
   // char *secret_data;
   long size_secret_file;       //size of secret file

    /* Stego Image Info */
    char *stego_image_fname;    //name of the ouput
    FILE *fptr_stego_image;    // address of output file
